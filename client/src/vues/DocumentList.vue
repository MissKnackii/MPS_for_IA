...
import FileComponent from '../components/GestionDocumentaire/inputFileComponent.vue';
   import SearchBarComponent from '../components/GestionDocumentaire/SearchBarComponent.vue'
